        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
              ...
              </span> Hey there 👋 I’m the founder of{' '}
            ...
            <p className="mt-5 text-sm inline-flex items-center">
              Follow me on
              <a href={"https://github.com/kamilsk"} className={"ml-4 mr-2 text-gray-800"}>
                <GitHubIcon className="h-7 w-7 fill-current" />
              </a>
              <a href={"https://www.linkedin.com/in/ikamilsk/"} className={"mx-2 text-blue-600"}>
                <LinkedInIcon className="h-8 w-8 fill-current" />
              </a>
              <a href="https://twitter.com/ikamilsk" className={"mx-2 text-gray-950"}>
